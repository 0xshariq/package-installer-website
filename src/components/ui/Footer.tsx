  ...
  return (
    <footer className="bg-slate-900/80 border-t border-indigo-500/30">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-2">
              <Button variant="ghost" size="icon" asChild className="text-slate-400 hover:text-indigo-300">
                <a 
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Button variant="ghost" asChild className="p-0 h-auto text-slate-400 hover:text-indigo-300 justify-start">
                  <Link href="/">
                    Home
                  </Link>
                </Button>
        ...
        {/* Bottom Section */}
        <Separator className="mt-8 bg-indigo-500/30" />
        <div className="mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <p className="text-slate-400 text-sm mt-2 md:mt-0">
            Made with ❤️ by <Button variant="link" asChild className="p-0 h-auto text-indigo-300 hover:text-indigo-200">
              <a 
